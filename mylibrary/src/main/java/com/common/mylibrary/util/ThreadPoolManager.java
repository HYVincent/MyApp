...
public class ThreadPoolManager {
    ...
    public static ThreadPoolManager getInstance(boolean isMultithreading) {
        if(mInstance == null){
            mInstance = new ThreadPoolManager(isMultithreading);
        }
        return mInstance;
    }
    ...
    private ThreadPoolManager(boolean isMultithreading) {
        if(isMultithreading){
            /**
